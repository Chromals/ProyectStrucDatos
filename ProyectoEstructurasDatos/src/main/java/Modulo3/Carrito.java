...
{
    List<NodosP> listaProductos= new ArrayList<>();
    Cliente client;
    ...
    public List<NodosP> getListaProductos() {
        return listaProductos;
    }

    public void setListaProductos(List<NodosP> listaProductos) {
        this.listaProductos = listaProductos;
    }
        ...
        if(listaProductos.isEmpty()) {
          JOptionPane.showMessageDialog(null, "El carrito esta vacio", "Error", JOptionPane.ERROR_MESSAGE);
            ...
            for(NodosP producto : listaProductos) {
                msg+= "-> Nombre: " + producto.getNombre()+" Codigo: "+producto.getCodigo() +" Fecha Vencimiento: " +producto.getFechaV() + " Precio: "+producto.getPrecio() + "\n";
            }
   ...
   public Carrito finalizarCompra()
    ...
    public String toString() {
        ...
        for(NodosP producto : listaProductos) {
            sb.append("Producto: \n").append(producto.toString()).append("\n");
        }
        return sb.toString();
    }
}
